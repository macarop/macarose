    ...
    <main className="min-h-screen flex items-center justify-center px-4"
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border p-8 shadow-xl"
          ...
          <button
            disabled
            className="w-full flex items-center justify-center gap-3 rounded-lg px-4 py-3 text-sm font-medium transition-opacity cursor-not-allowed opacity-60"
            style={{
          ...
          <p className="mt-4 text-center text-xs" style={{ color: "var(--foreground)", opacity: 0.35 }}>
            Authentification Google OAuth — bientôt disponible
          </p>
        </div>
